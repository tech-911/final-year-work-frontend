...
const Control = () => {
  ...
  return (
    <div className="flex flex-col items-center py-20 px-9 w-full h-full">
      <p className="text-[#546270] text-[40px] font-[700] mb-14 self-start">
        Control Application
      </p>
      <div className="flex lg:flex-row flex-col items-center gap-10 w-full">
        ...
        <div className="rounded-[14px] bg-[#d9d9d998] flex flex-col items-center gap-4 py-4 px-5 lg:w-[340px] w-[400px]">
          <FiImage className="text-[200px] text-[#708090]" />
        </div>
      </div>
    </div>
  );
