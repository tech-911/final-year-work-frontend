...
const Auth = () => {
  ...
  return (
    <div className="bg-[#D9D9D9] w-screen h-screen flex items-center">
      <div className="m-auto bg-white py-[1.875rem] w-[80%] h-fit rounded-lg sm:w-[55%] md:w-[50%] lg:w-[35%] xl:w-[30%] ">
        <form onSubmit={handlesubmit}>
          <label className="mb-[20px] block text-2xl text-center font-bold text-#546270 md:text-3xl md:mb-[2rem]">
            Login
          </label>
